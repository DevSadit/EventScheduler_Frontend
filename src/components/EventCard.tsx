...
const EventCard = ({ event }: EventCardProps) => {
  ...
  return (
    <div className={`bg-white dark:bg-gray-800 rounded-2xl shadow-sm hover:shadow-xl transition-all duration-300 border border-gray-100 dark:border-gray-700 overflow-hidden group ${event.archived ? 'opacity-60' : ''}`}>
      ...
      <div className="p-6 space-y-4">
        ...
        <div className="flex space-x-2 pt-2">
          ...
          <button className="flex-1 bg-red-50 hover:bg-red-100 dark:bg-red-900/20 dark:hover:bg-red-900/30 text-red-600 dark:text-red-400 font-medium py-2 px-4 rounded-xl transition-all duration-200 text-sm">
            Delete
          </button>
        </div>
      </div>
